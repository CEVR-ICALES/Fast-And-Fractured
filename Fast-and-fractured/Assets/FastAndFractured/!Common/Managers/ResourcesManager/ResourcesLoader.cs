...
public class ResourcesLoader : MonoBehaviour
{
    ...
    public void LoadResources(ref List<Sprite> playerIcons, ref List<Sprite> playerPortraits, ref List<Sprite> playerHalfBody, ref List<Sprite> uniqueAbilitiesIcons, ref List<Sprite> screenEffectsSprites, ref List<Sprite> keyboardIcons, ref List<Sprite> xboxIcons, ref List<Sprite> playstationIcons)
    {
